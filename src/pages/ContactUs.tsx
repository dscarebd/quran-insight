        ...
        <div className="bg-card rounded-xl p-5 md:p-8 shadow-sm border border-border">
          <div className={cn("space-y-6 text-foreground leading-relaxed", isBengali && "font-bengali")}>
            ...
            <p className="text-base md:text-lg">
              আমরা অতীব সাধারণ মানুষ। আমাদের ভুল হবে। আমাদের এই এ্যাপ এবং ওয়েবসাইটে যে কোন ধরণের ভুল, বা অসঙ্গতি দেখলে আমাদেরকে জানালে কৃতজ্ঞ থাকবো। যদি কোন কারণে কেউ কোন মত দিয়ে বা ভূল ধরিয়ে দিয়ে উপকার করার নিয়ত করি তাহলে কয়েকটি বিষয় খেয়াল রাখবো (ইনশাআল্লাহ):
            </p>
