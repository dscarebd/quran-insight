...
export const defaultLocations: Record<string, Location> = {
  // UTC-12 to UTC-1
  baker: { latitude: 0.1936, longitude: -176.4769, city: 'Baker Island' },
  samoa: { latitude: -13.8333, longitude: -171.75, city: 'Samoa' },
  honolulu: { latitude: 21.3069, longitude: -157.8583, city: 'Honolulu' },
  anchorage: { latitude: 61.2181, longitude: -149.9003, city: 'Anchorage' },
  losangeles: { latitude: 34.0522, longitude: -118.2437, city: 'Los Angeles' },
  denver: { latitude: 39.7392, longitude: -104.9903, city: 'Denver' },
  ...
  caracas: { latitude: 10.4806, longitude: -66.9036, city: 'Caracas' },
  saopaulo: { latitude: -23.5505, longitude: -46.6333, city: 'São Paulo' },
  atlantic: { latitude: 44.6488, longitude: -63.5752, city: 'Atlantic' },
  azores: { latitude: 37.7412, longitude: -25.6756, city: 'Azores' },
  // UTC+0
  ...
  fiji: { latitude: -18.1416, longitude: 178.4419, city: 'Fiji' },
  auckland: { latitude: -36.8485, longitude: 174.7633, city: 'Auckland' },
  samoa_east: { latitude: -13.8333, longitude: -171.75, city: 'Samoa (East)' },
};
