    ...
    <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
        ...
        <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl border border-border bg-card p-4 sm:p-6 transition-all duration-300 hover:shadow-elevated hover:-translate-y-1 hover:scale-[1.02]">
          ...
          <div className="mb-3 sm:mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className={cn("text-scale-sm font-semibold", language === "bn" && "font-bengali")}>
        ...
        <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl border border-border bg-card p-4 sm:p-6 transition-all duration-300 hover:shadow-elevated hover:-translate-y-1 hover:scale-[1.02]">
          ...
          <div className="mb-3 sm:mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2 text-gold-dark">
              ...
              <span className={cn("text-scale-sm font-semibold text-foreground", language === "bn" && "font-bengali")}>
          ...
          {(dua.title_bengali || dua.title_english) && (
            <p className={cn(
              "mb-2 sm:mb-3 text-center text-scale-sm font-semibold text-gold-dark",
              language === "bn" && "font-bengali"
            )}>
      ...
      {hadith && (
        <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl border border-border bg-card p-4 sm:p-6 transition-all duration-300 hover:shadow-elevated hover:-translate-y-1 hover:scale-[1.02]">
          ...
          <p className={cn(
            "mb-2 sm:mb-3 text-center text-scale-sm font-semibold text-muted-foreground",
            language === "bn" && "font-bengali"
          )}>
            {language === "bn" 
